...
public class Form_HoaDon extends javax.swing.JPanel {
    ...
    private Repository.Repository_HDCT repo_HDCT = new Repository_HDCT();
    private int index = -1;

    public Form_HoaDon() {
        initComponents();
        fillTable(repo_HD.getAll());
        fillTable1(repo_HDCT.getAll());
    }
    ...
    private void initComponents() {
        ...
        btn_SearchHD.setBackground(new java.awt.Color(51, 153, 255));
        ...
        btn_HDCT_Reset.setBackground(new java.awt.Color(0, 153, 255));
    ...
    private void tbl_DSHDMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_DSHDMouseClicked
        ...
        if (index < 0) {
            ...
            String maHDcantim = tbl_DSHD.getValueAt(index, 0).toString();
            repo_HDCT.timkiemHDCT(maHDcantim);
            fillTable1(repo_HDCT.timkiemHDCT(maHDcantim));
        }
...
//         Ask the user to confirm if they want to export the file
        ...
        try {
            String path = "D:\\FPTPolytechnic\\FALL2024\\block2\\DA1";
